# KryonMovement
Unity Rigidbody-Based Player Movement Script.

All it needs is a collider with default Rigidbody settings.

Currently not meant for First Person Applications.
